...
const MouseTrail = () => {
    useEffect(() => {
        // Define the window.onload function directly in the global scope
        function handleScript() {
            ...
            window.onload = function () {
                ...
                class rope {
                    ...
                    show() {
                        if(this.type == "l"){
                        // Access 'c' from the init function
                        c.beginPath();
    ...
    return (
        <canvas id="canvas" className="h-full w-full absolute z-1" ></canvas>
    );
};
